/*
 * This file is copied and modified from https://github.com/jcefmaven/jcefmaven/blob/8350ce27dd33ded92c6ea798f96caad162913a8f/jcefmaven/src/main/java/me/friwi/jcefmaven/EnumPlatform.java
 * */
...
import static online.ruin_of_future.jcef_example.PlatformPatterns.*;
    ...
    public static EnumPlatform getCurrentPlatform() throws UnsupportedPlatformException {
        ...
        for (EnumPlatform platform : values()) {
            supported
                    ...
                    .append("(")
                    .append(PROPERTY_OS_NAME)
                    .append(": ")
                    .append(Arrays.toString(platform.osMatch))
                    .append(", ")
                    .append(PROPERTY_OS_ARCH)
                    .append(": ")
